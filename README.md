...
<details> 
    ...
    <h4>Ce qui me motive</h4>
    <ul>
      <li>🛠️ Créer des solutions de mes propres mains</li>
      <li>💪 Relever de nouveaux défis techniques</li>
      <li>🕵️‍♂️ M'aventurer dans des domaines inconnus ou essayer de nouvelles technologies</li>
      <li>🐧 Contribuer à des projets Open Source</li>
      <li>🗣️ Participer à la traduction de tous types de projets</li>
    </ul>
    <h4>Mes traits de personnalité</h4>
    <ul>
      <li>👌 Perfectionniste</li>
      <li>🗒️ Organisé </li>
      <li>🧠 Créatif </li>
      <li>🦉 Oiseau de nuit </li>
    </ul>
    <h4>Mes autres passions ?</h4>
    <ul>
      <li>🗻 La montagne, été comme hiver 🚵‍♂️⛷️🏂</li>
      <li>🔊 Les festivals (<em>Hardmusic, Bass Music, Rock/Metal</em>) 🚐🕺🍻</li>
      <li>👾 Les jeux vidéo (<em>FPS, MMORPGs, Survie, Indés, etc.</em>) 🔫⚔️🧙‍♂️</li>
      <li>🏍️ La moto et les activités à sensations fortes 🎢🪂🛶</li>
    </ul>
</details>
<br/>
